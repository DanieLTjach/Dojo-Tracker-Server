...
router.get(
    '/',
    requireAuth,
    withTransaction((req, res) => gameController.getGames(req, res))
);
router.get(
    '/:gameId',
    requireAuth,
...
router.post(
    '/',
    requireAuth,
    withTransaction((req, res) => gameController.addGame(req, res))
);
...
router.put(
    ...
    requireAuth,
    requireAdmin,
    withTransaction((req, res) => gameController.editGame(req, res))
);
router.delete(
    '/:gameId',
    requireAuth,
    requireAdmin,
    withTransaction((req, res) => gameController.deleteGame(req, res))
);
