...
export class UserStatsRepository {
    ...
    private getTotalGamesInEventStatement: Statement<{ eventId: number }, { totalGames: number }> = db.prepare(
    ...
    private getUserRankInEventStatement: Statement<{ userId: number; eventId: number }, { place: number }> = db.prepare(
