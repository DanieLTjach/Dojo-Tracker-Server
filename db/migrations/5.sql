...
UPDATE gameRules SET details = '{"preset":"mahjong_soul_sanma","rules":{"abortive_draw":false,"agari_yame":"no","bankrupt":"none","blessing_of_man":"mangan","continuance_payment":"all","goal":30000,"kan_dora_called_promoted_quad":"before_discard","mangan_rounding_up":true,"noten_penalty":3000,"red_fives":"three_one_per_suit","riichi_1000_points_min":false,"riichi_without_a_next_draw":true,"tenpai_yame":"no","west_round":false}}' WHERE id = 3;
...
UPDATE gameRules SET details = '{"preset":"mahjong_soul","rules":{"abortive_draw":false,"blessing_of_man":"yakuman","kan_dora_called_promoted_quad":"before_discard","mangan_rounding_up":true,"call_precedence":"ron_first","riichi_without_a_next_draw":true,"west_round":false}}' WHERE id = 7;
...
UPDATE gameRules SET details = '{"preset":"mahjong_soul","rules":{"abortive_draw":false,"blessing_of_man":"yakuman","continuation":"agari","kan_dora_called_promoted_quad":"before_discard","mangan_rounding_up":true,"call_precedence":"ron_first","riichi_without_a_next_draw":true,"triple_ron":"cancel"}}' WHERE id = 9;
UPDATE gameRules SET details = '{"preset":"mahjong_soul","rules":{"abortive_draw":false,"bankrupt":"zero_or_less","blessing_of_man":"mangan","continuance_payment":"all","honba":"3x500","kan_dora_called_promoted_quad":"before_discard","red_fives":"three_one_per_suit","starting_points":30000,"west_round":false}}' WHERE id = 10;
