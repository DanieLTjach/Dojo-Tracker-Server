...
UPDATE gameRules SET details = '{"preset":"ema_2025","rules":{},"links":[{"url":"http://mahjong-europe.org/portal/images/docs/Riichi-rules-2025-EN.pdf","label":{"uk":"Офіційні правила EMA 2025 (PDF)"}}]}' WHERE id = 4;
UPDATE gameRules SET details = '{"preset":"mahjong_soul","rules":{},"links":[{"url":"https://riichi.wiki/Mahjong_Soul","label":{"uk":"Mahjong Soul на Riichi Wiki"}}]}' WHERE id = 5;
UPDATE gameRules SET details = '{"preset":"mahjong_soul_sanma","rules":{},"links":[{"url":"https://riichi.wiki/Mahjong_Soul#3P-Mahjong","label":{"uk":"Mahjong Soul Sanma на Riichi Wiki"}}]}' WHERE id = 6;
