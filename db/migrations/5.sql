...
UPDATE gameRules SET details = '{"preset":"mahjong_soul","rules":{"abortive_draw":false,"bankrupt":"zero_or_less","blessing_of_man":"mangan","chombo":"mangan","continuance_payment_on_multiple_ron":"all","kan_dora_called_promoted_quad":"before_discard","starting_points":30000,"west_round":false}}' WHERE id = 1;
UPDATE gameRules SET details = '{"preset":"ema_2025","rules":{"call_precedence":"ron_pon","chombo":"mangan","counted_yakuman":true,"double_yakuman":true,"nagashi_mangan":true,"nagashi_mangan_count_as_a_win":false,"red_fives":"three_one_per_suit","starting_points":30000,"yakuman_stacking":true}}' WHERE id = 2;
UPDATE gameRules SET details = '{"preset":"mahjong_soul_sanma","rules":{"abortive_draw":false,"agari_yame":"no","bankrupt":"none","blessing_of_man":"mangan","chombo":"mangan","continuance_payment_on_multiple_ron":"all","goal":35000,"kan_dora_called_promoted_quad":"before_discard","mangan_rounding_up":true,"noten_penalty":3000,"red_fives":"three_one_per_suit","riichi_1000_points_min":false,"riichi_without_a_next_draw":true,"tenpai_yame":"no","west_round":false}}' WHERE id = 3;
